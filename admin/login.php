...
if($_POST['username'] && $_POST['password']){
	...
	$admin_pass = a(htmlspecialchars($_POST['password']));
	if($admin_name==$huoduan['admin_name'] && $admin_pass==$huoduan['admin_pass']){
		$_SESSION['admin_huoduan'] = 'http://www.huoduan.com';
...
<head>
<title>后台管理登录 - Powered By Huoduan.com</title>
...
<tr class="header">
			<td colspan="4" align="center" style=" height:30px; font-size:18px; font-weight:bold;">系统登陆</td>
		</tr>
		<tr>
			<td width="117" align="right" valign="middle" class="tx" style="font-size:16px;">用户名：</td>
		  <td width="260" align="left" valign="middle"><input name="username" type="text" class="inp" id="username" value="" size="30" maxlength="32" autocomplete="off"></td>
		</tr>
		<tr>
		...
		<tr>
			<input name="act" type="hidden" value="go" /><input type="hidden" name="token" value="<?=md5(time())?>"/>   
		  <td align="center" colspan="4"><div class="cl5"></div><input type="submit" name="go" style="height:35px; width:100px;" value="     登 录    ">
<div class="cl5"></div>
<div style="height:30px; color:#F00; text-align:center; line-height:30px;"><?=$tips?></div>
          </td>
		</tr>
	</table>
<div class="mt2"></div>
...
<div class="cl10"></div>
<div id="footer">
  Powered by <a href="http://www.huoduan.com" target="_blank">Huoduan.com</a></div><!--footer-->
</BODY>
</HTML>
